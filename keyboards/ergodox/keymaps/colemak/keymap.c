...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_GRV,         KC_Q,         KC_W,   KC_F,   KC_P,   KC_G,   KC_VOLD,
        LT(SYMB, KC_TAB),KC_A,         KC_R,   LALT_T(KC_S),   LCTL_T(KC_T),   KC_D,
        ...
        // right hand
             ...
             KC_VOLU,    KC_J,   KC_L,   KC_U,   KC_Y,   KC_SCLN,          KC_EQL,
                          KC_H,   RCTL_T(KC_N),   RALT_T(KC_E),   KC_I,   KC_O,   LT(SYMB, KC_QUOT),
             KC_NO,KC_K,   KC_M,   KC_COMM,KC_DOT, CTL_T(KC_SLSH),   KC_RSFT,
                          KC_LEFT,  KC_DOWN,KC_UP,KC_RIGHT,         KC_BSLS,
             KC_PGDN,     KC_DEL,
             KC_PGUP,
             KC_RGUI, RSFT_T(KC_ENT), KC_SPC
    ),
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LPRN, KC_TRNS,
       ...
       KC_TRNS, KC_RPRN, KC_TRNS, KC_TRNS, KC_TRNS,KC_TRNS, KC_F12,
