...
[_QWERTY] = KEYMAP_5x7(
  // left hand
   ...
   KC_LSHIFT, KC_D,    LCTL_T(KC_T),    LALT_T(KC_S),    KC_R,   KC_A,   KC_TAB,
   ...
   /*                                      KC_LGUI, KC_LALT, */
        ...
        // right hand
              ...
              RSFT_T(KC_ENTER), KC_H,    RGUI_T(KC_N),     KC_E,    KC_I,    KC_O,    LT(_FN, KC_QUOT), 
              KC_RCTRL,  KC_K,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSHIFT,
